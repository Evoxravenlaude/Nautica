  ...
  return (
    <div className="fixed inset-0 bg-void flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        {/* Connect an already-installed wallet (MetaMask, Rainbow, WalletConnect, etc.)
            instead of creating/importing a mnemonic inside Nautica. */}
        <ConnectButton.Custom>
          {({ openConnectModal, account }) => (
            <button
              ...
              className="flex items-center justify-center gap-3 w-full py-4 border border-white/10 text-text-secondary font-mono text-sm tracking-wider hover:border-cyan/50 hover:text-cyan transition-all active:scale-[0.97]"
            >
              <Wallet size={18} />
      ...
      >
        ...
        <Link to="/terms" className="text-cyan hover:underline">Terms of Service</Link> and{" "}
